var db = {
	...
	faqOBankGenCustomerServiceHours: {
		...
		"slot_vals": null,
		"long_responses": ["Customer service will continue to be available 24 hours a day, 7 days a week."],
		"short_responses": ["We will be available 24/7."],
		"reprompts": ["What else would you like to know about?"]
	},
	faqOBankGenDebit: {
...
/* 	faqOBankGenMigrationHistory: {
	...
	faqOBankInvConvertInvestments: {
		...
		"slot_vals": null,
		"long_responses": ["There will be no need for account holders to liquidate or change their investment accounts. Investments will transfer to Optum Bank in-kind, meaning that individual investment accounts will transfer with the account holder’s current fund selections. In upcoming communications, Optum Bank will share more information about its overall investment offerings. "],
		"short_responses": ["There will be no need to liquidate or change investment accounts, and investments will transfer in-kind with current fund selections."],
		"reprompts": ["What else would you like to know about?"]
	},
	faqOBankInvInvestmentSweep: {
		...
		"slot_vals": null,
		"long_responses": ["Yes, there is a one-way sweep from the Optum Bank HSA to the investment account. The minimum automatic transfer amount above the investment threshold is $100. Optum Bank does not liquidate investments to maintain a cash balance in the HSA."],
		"short_responses": ["Yes."],
		"reprompts": ["What else would you like to know about?"]
	},
	...
	faqOBankInvSweepActivate: {
		...
		"slot_vals": null,
		"long_responses": ["Activating/deactivating the investment sweep is available online. The sweep can also be activated/deactivated by calling the call center, but the investment account and fund designation must be assigned prior to the call."],
		"short_responses": ["This feature is avaliable online, or calling the call center."],
		"reprompts": ["What else would you like to know about?"]
	},
	faqOBankInvThreshold: {
		...
		"short_responses": ["Thresholds will be maintained, and will be carried forward from Wells Fargo."],
		"reprompts": ["What else would you like to know about?"]
	},
	...
	faqOBankOnlMobileWallet: {
		...
		"short_responses": ["Not currently, but this feature is upcoming."],
		"reprompts": ["What else would you like to know about?"]
	},
	...
	faqOBankTaxMigrationImplications: {
		...
		"short_responses": ["No tax implications associated with the transfer."],
		"reprompts": ["What else would you like to know about?"]
	},
	...
	faqOBankTaxStatementGeneration: {
		...
		"slot_vals": null,
		"long_responses": ["Optum Bank statements are available online for 36 months. Paper statements are also available upon request."],
		"short_responses": ["Online statements are available for 36 months, whereas paper statements are available upon request."],
		"reprompts": ["What else would you like to know about?"]
	},
	...
	faqOBankUHC: {
		...
		"short_responses": ["No. A new account will need to be created."],
		"reprompts": ["What else would you like to know about?"]
	},
	faqOBankUHCOnlineAccess: {
		...
		"slot_vals": null,
		"long_responses": ["Once migration has occurred, account holders will be notified that they no longer have access to their HSAs through Wells Fargo Online®. They will receive instructions and links to access their HSAs through Optum Bank and/or myuhc.com if they have UnitedHealthcare health insurance. "],
		"short_responses": ["Access to your HSA will be only through Optum Bank HSA."],
		"reprompts": ["What else would you like to know about?"]
	},
